...
<!-- Nơi token được khai báo thật trong code. /implement phải dùng các biến này, KHÔNG viết hex/px thẳng. -->
- Tailwind v4: khai báo token trong `webapp/src/app/globals.css` ở block `@theme { --color-...: ...; }`
